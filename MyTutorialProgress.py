...
fig.vbar(x=day_num, bottom=0, top=daily_words, color="blue", width=0.75, legend="Daily")

# The cumulative sum will be a trend line
fig.line(x=day_num, y=cumulative_words, color="gray", line_width=1, legend="Cumulative")
